	...
	return (
		<header className="bg-gray-900">
			<div className="flex items-baseline justify-between px-4 py-3">
				<div>
					<svg className="h-8 w-auto" viewBox="0 0 185 32" fill="none">
			...
			<div className={`px-2 pt-2 pb-4 ${isOpen ? 'block' : 'hidden'}`}>
				<a href="#" className="block text-white font-semibold hover:bg-gray-800 rounded px-2 py-1">List your property</a>
				<a href="#" className="block text-white font-semibold hover:bg-gray-800 rounded px-2 py-1 mt-1">Trips</a>
				<a href="#" className="block text-white font-semibold hover:bg-gray-800 rounded px-2 py-1 mt-1">Messages</a>
			</div>
		</header>
	);
}
